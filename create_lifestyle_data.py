...
try:
    ...
    #     sql = "INSERT INTO LifestyleStats (Stats_id, Username, Date, Hours_of_sleep, Grams_of_protein, Type_of_exercise, Minutes_of_exercise) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    #     val = (stats_id, username, date, hours_of_sleep, grams_of_protein, type_of_exercise, minutes_of_exercise)
    #     cur.execute(sql, val)
